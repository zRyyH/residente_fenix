...
export default function Header({ user, onLogout }) {
    ...
    return (
        <header className="glass-card-light backdrop-blur-md p-4 mb-6 flex justify-between items-center rounded-xl border border-blue-900/40 animate-fade-in-down relative z-50">
            <div className="flex items-center gap-2">
                <div className="bg-gradient-to-r from-blue-500 to-indigo-600 p-3 rounded-xl shadow-md text-white transition-scale hover-scale">
                    <Droplets size={24} />
                </div>
                <div>
            ...
            <div className="hidden md:flex items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {user && (
                        <div className="flex items-center gap-2 bg-blue-900/30 px-3 py-1 rounded-full text-white animate-fade-in">
            ...
            {/* Menu mobile - Animação mais sutil */}
            {mobileMenuOpen && (
                <div className="fixed top-20 right-4 left-4 bg-gray-900 border border-blue-900/40 rounded-xl p-4 z-[100] animate-slide-down md:hidden shadow-xl">
                    <div className="flex flex-col space-y-4">
                        <a href="/dashboard" className="flex items-center gap-2 text-white p-2 hover:bg-blue-800/50 rounded-lg">
                            <BarChart size={20} />
                            <span>Dashboard</span>
                        </a>
