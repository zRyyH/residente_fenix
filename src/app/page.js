...
import { login, checkResidentProfile, logout } from "@/lib/auth";
import { obterDadosConsumo } from "@/lib/consumo";
import { Droplets, Lock, Mail, ArrowRight, AlertCircle, X, Home as HomeIcon } from "lucide-react";
...
export default function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // 1. Realiza o login do usuário
      await login(email, password);

      // 2. Verifica se o usuário é um Residente
      const isResident = await checkResidentProfile();
      ...
      // 3. Se for residente, busca os dados de consumo
      try {
        await obterDadosConsumo();
      } catch (consumoErr) {
        console.error("Erro ao buscar dados de consumo:", consumoErr);
        // Continua o fluxo mesmo com erro nos dados de consumo
      }
          ...
          <div className="glass-card-light max-w-md w-full mx-4 p-6 animate-fade-in border border-blue-900/40">
            ...
            <div className="mb-6">
              <p className="text-gray-300 mb-4">
                Você não possui permissão para acessar o painel de residente. Este sistema é exclusivo para usuários com perfil de Residente.
              </p>
          ...
          <div className="max-w-md text-white">
            <div className="flex items-center mb-8">
              ...
              <div className="ml-4">
                ...
                <p className="text-white mt-1">Área do Residente</p>
              </div>
            </div>

            <h2 className="text-3xl font-medium mb-8">Acompanhe o consumo de água do seu apartamento</h2>

            <div className="grid grid-cols-2 gap-6 mb-12">
              <div className="glass-card-light p-5 rounded-xl border border-blue-900/40">
                <h3 className="font-medium mb-2">Consumo Individual</h3>
                <p className="text-sm text-blue-100">Visualize seu consumo de água mensal e histórico de uso</p>
              </div>
              <div className="glass-card-light p-5 rounded-xl border border-blue-900/40">
                <h3 className="font-medium mb-2">Conta Detalhada</h3>
                <p className="text-sm text-blue-100">Confira os detalhes de suas contas e faturas mensais</p>
              </div>
              <div className="glass-card-light p-5 rounded-xl border border-blue-900/40">
                <h3 className="font-medium mb-2">Notificações</h3>
                <p className="text-sm text-blue-100">Receba alertas sobre consumo elevado ou vazamentos</p>
              </div>
              <div className="glass-card-light p-5 rounded-xl border border-blue-900/40">
                <h3 className="font-medium mb-2">Economia</h3>
                <p className="text-sm text-blue-100">Dicas para uso consciente e redução no consumo de água</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-0">
          <div className="w-full max-w-md">
            ...
            <div className="glass-card-light p-8 animate-fade-in border border-blue-900/40">
              <div className="mb-8">
                <h2 className="text-2xl font-bold mb-2">Bem-vindo(a), Residente</h2>
                <p className="text-gray-300">
                  Acesse sua conta para acompanhar o consumo de água do seu apartamento
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="seu.email@example.com.br"
              ...
              <div className="mt-8 pt-6 border-t border-gray-700/50 text-center text-sm text-gray-300">
                <p>Portal exclusivo para residentes do condomínio</p>
